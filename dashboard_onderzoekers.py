...
# --- Instellingen (woordenboeken bovenin, makkelijk aan te passen) -----------
KLEUREN = {
...
# Begin van de kolomnaam; achter komt ' 1'/' 2' (meting) en '_man/_vrouw/_anders' (geslacht)
